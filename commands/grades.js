...
module.exports.run = async (bot, message, args) => {
  ...
  let data = await getData(subject, course, section, term);
  let test = sectionCheck(section);
  console.log(test);
  ...
  async function getCourseData(body, subject, course, section, term) {
